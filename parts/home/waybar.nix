      ...
      settings = {
        mainBar = {
          ...
          "custom/launcher" = {
            format = "=";
            tooltip = false;
            on-click = "j4-dmenu-desktop --no-generic --dmenu=\"bemenu -l 10 -p run: --fn 'Terminus 12' -c --width-factor 0.3 --nb '#000000ff' --hb '#000000ff' --fb '#000000ff' --ab '#000000ff' --hf '#ffea00ff' -B 1 --bdr '#8b3a5aff'\"";
          };
          "custom/tailscale" = {
            format = "TS";
            tooltip = false;
